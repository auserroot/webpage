...
<head>
    ...
    <meta name="description" content="可搜索试听网易云音乐、QQ音乐、酷狗音乐、酷我音乐、虾米音乐、百度音乐、一听音乐、咪咕音乐、荔枝FM、蜻蜓FM、喜马拉雅FM、全民K歌、5sing原创翻唱音乐。">
...
<body>  
    <section class="am-g about">
        <div class="am-container am-margin-vertical-xl">
            <header class="am-padding-vertical">
                ...
                <p class="am-text-center">全网音乐搜索</p>
            </header>
            <hr>
            <div class="am-u-lg-12 am-padding-vertical">
                <form id="j-validator" class="am-form am-margin-bottom-lg" method="post">
                    <div class="am-u-md-12 am-u-sm-centered">
                        ...
                        <div class="am-form-group">
                            <input id="j-input" data-filter="name" class="am-form-field am-input-lg am-text-center am-radius" placeholder="例如: 出山 花粥" data-am-loading="{loadingText: ' '}" pattern="^.+$" required>
                ...
                <form id="j-main" class="am-form am-u-md-12 am-u-sm-centered music-main">
                    <a type="button" id="j-back" class="am-btn am-btn-success am-btn-lg am-btn-block am-radius am-margin-bottom-lg">成功搜索 &#x221A; 返回继续 <i class="am-icon-reply am-icon-fw"></i></a>
                ...
                <div class="am-u-md-12 am-u-sm-centered am-margin-vertical music-tips">
                    <h4>帮助：</h4>
                    <p><b>红色数字</b> 为 <strong>音乐 ID</strong>，<u>下划线</u> 表示 <strong>音乐URL</strong></p>
    ...
    <footer class="footer">
        <p class="am-text-sm">v<?php echo MC_VERSION; ?>&nbsp;&copy;&nbsp;<?php echo date('Y'); ?>&nbsp;<a href="https://github.com/auserroot/Programming.git" target="_blank" rel="author">源码下载</a>&nbsp;<a href="#" data-am-modal="{target: '#copr-info'}">免责声明</a></p>
    </footer>
